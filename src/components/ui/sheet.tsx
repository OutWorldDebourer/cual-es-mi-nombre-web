...
const sheetContentVariants = cva(
  "fixed z-50 flex flex-col gap-4 bg-white/60 backdrop-blur-xl border-black/[0.06] dark:bg-white/[0.04] dark:border-white/[0.08] p-6 shadow-lg transition ease-in-out data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:animate-in data-[state=open]:duration-300",
  {
    variants: {
      side: {
