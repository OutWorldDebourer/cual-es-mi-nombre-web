...
|------|-------------|---------------|
| `page.tsx` | Client Component with form to edit display name, assistant name, timezone (LATAM presets), and message wait seconds; writes directly to Supabase profiles table; save button uses loading prop | T8 · 2026-04-01 |
