...
| `api-funnel.test.ts` | Tests `backendApi.funnel.track` — request shape, fire-and-forget error swallowing (network / 4xx / 5xx / 401 / 503), and TS literal-union event contract | 2026-04-24 |
